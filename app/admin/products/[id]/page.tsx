...
export default function EditProductPage() {
  ...
  if (loading) {
    return <div style={{ padding: 60, textAlign: 'center', color: 'var(--color-text-tertiary)' }}>Loading product...</div>;
  }
    ...
    <div style={{ maxWidth: 640 }}>
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div className="admin-form-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <Input label="Price (NPR)" type="number" value={form.price} onChange={(e) => update('price', e.target.value)} required />
